...
## Comparison of BNs from Quesions 2 and 3
...
All three BNs have the same misclassifications rate of `r misscl2`. As the Markov Blanket of S is the same in the learnt BN and the true BN, the predictions in the question 3 are also the same as the predictions in the question 2.
