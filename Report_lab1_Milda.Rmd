...
The Naive Bayes Classifier produced slightly worse results. This is due to the loss of some information (for example, the Markov Blanket of S in Naive Bayes is different from the Markov Blanket in other questions). 
